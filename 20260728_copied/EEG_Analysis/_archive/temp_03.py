...
gs = gridspec.GridSpec(4, 6, height_ratios=[2, 0.4, 1, 0.4])
...
time_list = [           #sec
    ...
    # [[3200, 3240]],
    # # [[3300, 3400]],
    [[2325, 2335],[2338, 2346],[2442, 2443],[2005, 2009]], #spikeあり
    [[2335, 2338],[2347, 2351], [2440, 2442], [1945, 1949]] #spikeなし
...
# ns2ファイルのパス
file_path = r"\\DESKTOP-WS2\data\Zhou\Behavior\EEG\z129_SYNCit-C_high_titer_ROI\20240527_z129_SYNCit-C_2nd-ip_before&after_rapa\z129_after_rapa002.ns2"
=======
    [[2100, 2400]],
    [[2400, 2700]],
    [[2700, 3000]],
...
>>>>>>> 10abac5d6442635ae07be353b05b12d13a85667c
